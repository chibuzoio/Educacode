...
?>                                    
    ...
    <div id="communityWindow" class="col-xs-12 communityWindow whiteBody">                                  
    	<div id="communityDivision" class="communityDivision col-xs-9">
            ...
            <div id="educacodeCommunityQuestions" class="educacodeCommunityQuestions"></div>
    		...
    		<div id="questionAnswerSection" class="questionAnswerSection hideComponent">
    			...
    			<div id="questionSection" class="questionSection col-xs-11">
    				<div class="questionTitle headerColor">
    					How To Deploy Java Web Application On Virtual Private Server?     
    				</div>                                           
    				<div class="questionAnswererAsker blurColor col-xs-6">Question By Bruce Smith</div>                                    
    				<div class="askAnswerTime blurColor col-xs-6">2017-07-14 16:18:44</div>
    				<div class="questionContent baseColor">
    					aglajf lkaslk fjlkajflk ajflkdj lakfjslk jlfkasj lkajlfkdsj
    					sfksajf hasklh fksahkf hfaskjfh kjsahfk jhsakj hkjash kfj
    					safkhsfkj hkasjh aglajf lkaslk fjlkajflk ajflkdj lakfjslk jlfkasj lkajlfkdsj
    				</div>
    			...
    			<div class="questionSection col-xs-11">                                            
    				...
    				<div class="answerInformation">
    					...
    					<div class="answerClapperInfo col-xs-2 semiBlurColor">65&nbsp;claps</div>                                               
    					<!-- toggle commentIcon-on fa-comment with commentIcon-off fa-comment-o -->
    					<div title="reply" class="answerIcon-off icon fa-comment-o col-xs-1"></div>                                   
    					<div class="replyInfo semiBlurColor col-xs-2">65&nbsp;replies</div>
    				</div>                                             
    			</div>                                   
    		</div>                                          
            ...
            <div id="prepareQuestionDivision" class="hideComponent">                                                 
                <div id="prepareQuestionComponents" class="hideComponent">                                                         
                    ...
                    <div id="questionCategoryError" class="questionCategoryError hideComponent">Please Check Your Question Categories!</div>                                        
                </div>                                            
                ...
                <div id="askQuestionDivision" class="askQuestionDivision col-xs-12">                                              
                    ...
                    <div id="postQuestionNow" class="postQuestionNow">Post Question</div>
    	...
    	<div class="informationDivision col-xs-3">
            <div id="askQuestionButton" class="askQuestionButton hideComponent">Ask Question</div>
