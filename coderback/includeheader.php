...
<html>
	...
	<body id="educacode">                                           
		<div id="educacodeHeader" class="header col-xs-12">
			...
			<div id="educacodeEntrance" class="loginButton baseColor hideComponent"><a href="signup.php" class="signUpAnchor"><span class="icon fa-sign-in"></span>&nbsp;Sign&nbsp;In</a></div>                                   
